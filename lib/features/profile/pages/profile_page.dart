          ...
          child: ConstrainedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                const Text(
                  'Información de cuenta, datos personales y preferencias.',
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: 20),
                AssessmentEntry(
                  store:
                      widget.assessmentStore ??
                      TrainingProfileStore(
                        storageUserId: widget.previewMode ? 'preview' : null,
                      ),
                  membershipActive: widget.membership.active,
                ...
                FeatureListItem(
                  ...
                  description: widget.membership.active
                      ? 'Membresía activa validada desde el perfil conectado.'
                      : 'Sin membresía activa. Puedes usar Inicio, evaluación, Info y Perfil.',
                ),
                FeatureListItem(
                  icon: Icons.person_outline,
                  title: 'Nombre',
                  description: widget.membership.name.isEmpty
                      ? 'Pendiente de sincronizar desde administración.'
